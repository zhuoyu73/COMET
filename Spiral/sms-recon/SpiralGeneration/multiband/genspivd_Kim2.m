function [Gx, Gy, kx, ky, sx, sy]=genspivd_Kim2(D, N, nl, gamp, gslew, gts, alphavd); 
...
l2 = length(gx);
Gx = real(gx(1:1:l2));   % or gx(1:2:l2)*MAX_PG_WAMP/gamp
Gy = imag(gx(1:1:l2));   % or gy(1:2:l2)*MAX_PG_WAMP/gamp
