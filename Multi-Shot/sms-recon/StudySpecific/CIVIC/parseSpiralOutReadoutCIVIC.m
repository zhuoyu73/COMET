function obj = parseSpiralOutReadoutCIVIC(obj)
...
if obj.multibandFactor > 1
    kzc = (-obj.multibandFactor/2):(obj.multibandFactor/obj.nPartitions):(obj.multibandFactor/2-1);
end
...
if obj.useGIRF
    ...
    obj.shotLength = length(obj.kxNominal(:,1)); %Assume kxt and kyt are the same length
    obj.kx = repmat(obj.kxNominal(1:obj.shotLength,:),[1,1,obj.nPartitions, obj.nSlices,obj.nAverages, obj.nPhases, obj.nEchoes, obj.nRepetitions,1]);
    obj.ky = repmat(obj.kyNominal(1:obj.shotLength,:),[1,1,obj.nPartitions, obj.nSlices,obj.nAverages, obj.nPhases, obj.nEchoes, obj.nRepetitions,1]);
    kzc = permute(kzc,[3,1,2]);
    obj.kz = repmat(kzc,[length(kxc(1:obj.shotLength,1)),obj.nShots,1, obj.nSlices,obj.nAverages, obj.nPhases, obj.nEchoes, obj.nRepetitions,1]);
