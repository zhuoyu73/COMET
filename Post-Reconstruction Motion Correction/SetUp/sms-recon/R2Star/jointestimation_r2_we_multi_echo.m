function [r2final, wefinal] = jointestimation_r2_we_multi_echo(data,maskTE,rInfo, FM, sen, r2map,han_flag, numloop,numloop_ext,mask)
...
for ii=1:numloop_ext
    ...
    if ii ==1
        ...
        im_rec = qpwls_pcg(xinit(:),A_t0s,1,col(data0s),0,C,1,5,[],0);
    end
