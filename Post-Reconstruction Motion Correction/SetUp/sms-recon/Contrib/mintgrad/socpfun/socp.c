...
void dzero(ptrdiff_t n, double *p)
/*
...
void dupge(ptrdiff_t n, double *A)
/*
...
void dgapdev(ptrdiff_t m, int L, ptrdiff_t *N, double *u, double *z,
             double *pgap, double *pdev)
/*
...
void dhess(
    /* input args. */
    ptrdiff_t L, double *d3, /* pre-computed constants */
...
void socp_getwork(
    /* input args.: */
    ptrdiff_t L, ptrdiff_t *N, ptrdiff_t n, int max_iter, int out_mode,
    /* output args.: */
...
int socp(ptrdiff_t L, ptrdiff_t *N, ptrdiff_t n,

         double *f, double *A, double *b,

         double *x, double *z,

         double abs_tol, double rel_tol, double target, mwSize *iter,

         double Nu,

         int *info, int out_mode, double *hist,

         double *dblwork, ptrdiff_t *intwork)
/*
