classdef recoInfo
    %recoInfo - Class for reconstruction info object for Siemens VB/VD/VE files
    %
    ...
    % email address:
    % Website:
    % July 2016; Last revision: 12-Dec-2017
    ...
    properties
        ...
        useGIRF
        recType reconType = reconType.COIL_IMAGES_ONLY; %Restricts this property to only values of reconType
        nIter = 10;
        L;
        Robj;
        PreWhiten = false;
    ...
    methods
        function obj = recoInfo(filename,varargin)
	...
	elseif (strcmp(sequenceString,'SENFMv3'))
                obj = parseSENFMv3(obj);
            ...
            elseif (strcmp(sequenceString,'osc3Dmb'))
                obj = parse_osc3Dmb(obj);
