classdef pcSENSE_ZS2
    ...
    methods
        function obj = pcSENSE_ZS2(A,phaseMaps,sen,T,varargin) %ZS added T
            ...
            if ~obj.isTranspose % Forward operation
                ...
                for indx = 1:obj.nShots
                    ...
                    for idx = 1:4
                        ...
                        %x_warped_2d = imwarp(real(x_2d), tform, 'OutputView', imref2d([120,120]),'Interp','linear') ...
                        % + 1i * imwarp(imag(x_2d), tform, 'OutputView', imref2d([120,120]),'Interp','linear');
                ...
                for indx = 1:obj.nShots
                    ...
                    for idx = 1:4
                        ...
                        %y_warped_2d = imwarp(real(y_2d), tform, 'OutputView', imref2d([120,120]),'Interp','linear') ...
                        % + 1i * imwarp(imag(y_2d), tform, 'OutputView', imref2d([120,120]),'Interp','linear');
