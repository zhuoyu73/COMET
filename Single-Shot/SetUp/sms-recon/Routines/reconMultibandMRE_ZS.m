...
if rInfo.nCoils < 32
img = phaseCorrectedRecon_ZS(rInfo, senMB, maskMB, FMMB, PMaps, affine_matrices,'Niter',Niter,'L',L,'Rbeta',Rbeta,'dims2penalize',[1,1,0],'repetitionsToRecon',repetitionsToRecon,'slicesToRecon',slicesToRecon);
else
img = phaseCorrectedRecon_ZS(rInfoCC, senCC, maskMB, FMMB, PMaps, affine_matrices,'Niter',Niter,'L',L,'Rbeta',Rbeta,'dims2penalize',[1,1,0],'repetitionsToRecon',repetitionsToRecon,'slicesToRecon',slicesToRecon);
end
