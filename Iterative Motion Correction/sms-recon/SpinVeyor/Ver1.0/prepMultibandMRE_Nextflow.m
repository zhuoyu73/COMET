function prepMultibandMRE_Nextflow(fieldMapDataFilename,twixDatFilename, outputFilename)
% function prepMultibandMRE_Nextflow(datadir,filename)
%
...
PMaps = calcMRENavPhaseErrors(rInfo, imgNav); %AMC CHANGE!
